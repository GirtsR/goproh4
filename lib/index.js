...
function retrieveMacAddress(cam) {
    request({ url: `http://${cam._ip}/gp/gpControl` }, function (error, response, body) {
...
GoPro.Camera.prototype.restartStream = function () {
    ...
    return this._retryPromise(function (resolve, reject) {
        ...
        request.get({ url: url, insecureHTTPParser: true, timeout: 10 * 1000 }, function (error, response, body) {
            if (!error && response.statusCode === 200) {
                self._keepAliveStart();
                return resolve();
            }
